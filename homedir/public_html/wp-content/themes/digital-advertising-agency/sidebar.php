<div class="sidebar-area mt-5">
    <?php if ( ! dynamic_sidebar( 'digital-advertising-agency-sidebar' ) ) : ?>
      <h4 class="title"><?php esc_html_e('Search Here', 'digital-advertising-agency'); ?></h4>
        <form method="get" id="searchform" class="searchform" action="<?php echo esc_url(home_url('/')); ?>">
            <input placeholder="<?php esc_attr_e('Type here...', 'digital-advertising-agency'); ?>" type="text" name="s" id="search" value="<?php the_search_query(); ?>" />
            <input type="submit" class="search-submit" value="<?php esc_attr_e('Search', 'digital-advertising-agency');?>" />
        </form>
